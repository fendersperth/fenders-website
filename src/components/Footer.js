...
export const Footer = () => (
    <footer className="clearfix" role="contentinfo">
        <div className="container">
            ...
            <a className="logo" href="" title="Fenders"><span>Fenders</span></a>
            ...
            <nav className="social">
                <ul>
                    <li><a className="twitter" href="https://twitter.com/fendersperth" title="Twitter"><span>Twitter</span></a></li>
                    <li><a className="slack" href="https://fendersslack.herokuapp.com/" title="Slack"><span>Slack</span></a></li>
                </ul>
            </nav>
